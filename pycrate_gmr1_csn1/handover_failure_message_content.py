...
# *
# *--------------------------------------------------------
# * File Name : pycrate_gmr1_csn1/handover_failure_message_content.py
# * Created : 2023-10-24
# * Authors : Benoit Michau
# *--------------------------------------------------------
#*/
# specification: ETSI TS 101 376-04-13
# section: 9.2.15           HANDOVER FAILURE
# top-level object: HANDOVER FAILURE message content
...
handover_failure_message_content = CSN1List(name='handover_failure_message_content', list=[
