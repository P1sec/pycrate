...
# *
# *--------------------------------------------------------
# * File Name : pycrate_gmr1_csn1/downlink_direct_transfer_message_content.py
# * Created : 2023-10-24
# * Authors : Benoit Michau
# *--------------------------------------------------------
#*/
# specification: ETSI TS 101 376-04-13
# section: 9.2.5            DOWNLINK DIRECT TRANSFER
# top-level object: DOWNLINK DIRECT TRANSFER message content
...
downlink_direct_transfer_message_content = CSN1List(name='downlink_direct_transfer_message_content', list=[
  CSN1Val(name='', val='0'),
  CSN1List(list=[
