...
# *
# *--------------------------------------------------------
# * File Name : pycrate_gmr1_csn1/signalling_connection_release_message_content.py
# * Created : 2023-10-24
# * Authors : Benoit Michau
# *--------------------------------------------------------
#*/
# specification: ETSI TS 101 376-04-13
# section: 9.2.48          SIGNALLING CONNECTION RELEASE
# top-level object: SIGNALLING CONNECTION RELEASE message content
...
signalling_connection_release_message_content = CSN1List(name='signalling_connection_release_message_content', list=[
  CSN1Val(name='', val='0'),
  CSN1List(list=[
