...
# *
# *--------------------------------------------------------
# * File Name : pycrate_gmr1_csn1/initial_direct_transfer_message_content.py
# * Created : 2023-10-24
# * Authors : Benoit Michau
# *--------------------------------------------------------
#*/
# specification: ETSI TS 101 376-04-13
# section: 9.2.17           INITIAL DIRECT TRANSFER
# top-level object: INITIAL DIRECT TRANSFER message content
...
from pycrate_gmr1_csn1.intra_domain_nas_node_selector_ie import intra_domain_nas_node_selector_ie
...
initial_direct_transfer_message_content = CSN1List(name='initial_direct_transfer_message_content', list=[
  CSN1Ref(name='cn_domain_identity', obj=cn_domain_identity_ie),
  CSN1Ref(name='intra_domain_nas_node_selector', obj=intra_domain_nas_node_selector_ie),
