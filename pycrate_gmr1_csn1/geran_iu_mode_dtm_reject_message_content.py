...
# *
# *--------------------------------------------------------
# * File Name : pycrate_gmr1_csn1/geran_iu_mode_dtm_reject_message_content.py
# * Created : 2023-10-24
# * Authors : Benoit Michau
# *--------------------------------------------------------
#*/
# specification: ETSI TS 101 376-04-13
# section: 9.2.58          GERAN Iu mode DTM REJECT
# top-level object: GERAN Iu mode DTM REJECT message content
...
from pycrate_gmr1_csn1.wait_indication_ie import wait_indication_ie
...
geran_iu_mode_dtm_reject_message_content = CSN1List(name='geran_iu_mode_dtm_reject_message_content', list=[
  ...
  CSN1Ref(name='wait_indication', obj=wait_indication_ie)])
