...
# *
# *--------------------------------------------------------
# * File Name : pycrate_gmr1_csn1/rab_information_to_reconfigure_ie.py
# * Created : 2023-10-24
# * Authors : Benoit Michau
# *--------------------------------------------------------
#*/
# specification: ETSI TS 101 376-04-13
# section: 9.3.76         RAB Information to Reconfigure
# top-level object: RAB Information to Reconfigure IE
...
rab_information_to_reconfigure_ie = CSN1List(name='rab_information_to_reconfigure_ie', list=[
