...
# *
# *--------------------------------------------------------
# * File Name : pycrate_gmr1_csn1/position_report_response_message_content.py
# * Created : 2023-10-24
# * Authors : Benoit Michau
# *--------------------------------------------------------
#*/
# specification: ETSI TS 101 376-04-13
# section: 9.2.21a POSITION REPORT RESPONSE
# top-level object: POSITION REPORT RESPONSE message content
...
position_report_response_message_content = CSN1List(name='position_report_response_message_content', list=[
  CSN1Val(name='', val='0'),
  CSN1List(list=[
