...
# *
# *--------------------------------------------------------
# * File Name : pycrate_gmr1_csn1/cn_information_info_ie.py
# * Created : 2023-10-24
# * Authors : Benoit Michau
# *--------------------------------------------------------
#*/
# specification: ETSI TS 101 376-04-13
# section: 9.3.17         CN Information Info
# top-level object: CN Information info IE

# external references
from pycrate_gmr1_csn1.plmn_identity_ie import plmn_identity_ie
...
cn_information_info_ie = CSN1List(name='cn_information_info_ie', list=[
  CSN1Alt(alt={
    '0': ('', []),
    '1': ('', [
    CSN1Ref(name='plmn_identity', obj=plmn_identity_ie)])}),
  CSN1Alt(alt={
    '0': ('', []),
    '1': ('', [
