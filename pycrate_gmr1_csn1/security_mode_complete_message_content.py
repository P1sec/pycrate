...
# *
# *--------------------------------------------------------
# * File Name : pycrate_gmr1_csn1/security_mode_complete_message_content.py
# * Created : 2023-10-24
# * Authors : Benoit Michau
# *--------------------------------------------------------
#*/
# specification: ETSI TS 101 376-04-13
# section: 9.2.46          SECURITY MODE COMPLETE
# top-level object: SECURITY MODE COMPLETE message content
...
security_mode_complete_message_content = CSN1List(name='security_mode_complete_message_content', list=[
  ...
  CSN1Alt(alt={
    '0': ('', []),
    '1': ('', [
    CSN1Ref(name='last_used_ciphering_algorithm', obj=ciphering_algorithm_ie)])})])
