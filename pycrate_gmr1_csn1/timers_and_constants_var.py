...
# *
# *--------------------------------------------------------
# * File Name : pycrate_gmr1_csn1/timers_and_constants_var.py
# * Created : 2023-10-24
# * Authors : Benoit Michau
# *--------------------------------------------------------
#*/
# specification: ETSI TS 101 376-04-13
# section: 10.4.27 TIMERS_AND_CONSTANTS
# top-level object: TIMERS_AND_CONSTANTS VAR
...
timers_and_constants_var = CSN1List(name='timers_and_constants_var', list=[
