...
# *
# *--------------------------------------------------------
# * File Name : pycrate_gmr1_csn1/packet_downlink_ack_nack_message_content.py
# * Created : 2023-10-24
# * Authors : Benoit Michau
# *--------------------------------------------------------
#*/
# specification: ETSI TS 101 376-04-12
# section: 11.2.6a Packet downlink Ack/Nack (Iu mode only)
...
packet_downlink_ack_nack_message_content = CSN1List(name='packet_downlink_ack_nack_message_content', list=[
  CSN1Bit(name='downlink_tfi', bit=8),
  ...
  CSN1Alt(alt={
    '0': ('', []),
    '1': ('', [
    CSN1Bit(name='channel_request_description', bit=17)])}),
  CSN1Alt(alt={
    '0': ('', []),
    '1': ('', [
