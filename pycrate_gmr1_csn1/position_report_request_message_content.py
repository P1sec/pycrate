...
# *
# *--------------------------------------------------------
# * File Name : pycrate_gmr1_csn1/position_report_request_message_content.py
# * Created : 2023-10-24
# * Authors : Benoit Michau
# *--------------------------------------------------------
#*/
# specification: ETSI TS 101 376-04-13
# section: 9.2.20a POSITION REPORT REQUEST
# top-level object: POSITION REPORT REQUEST message content
...
position_report_request_message_content = CSN1List(name='position_report_request_message_content', list=[
  CSN1Val(name='', val='0'),
  CSN1List(list=[
