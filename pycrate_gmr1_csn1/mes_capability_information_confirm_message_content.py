...
# *
# *--------------------------------------------------------
# * File Name : pycrate_gmr1_csn1/mes_capability_information_confirm_message_content.py
# * Created : 2023-10-24
# * Authors : Benoit Michau
# *--------------------------------------------------------
#*/
# specification: ETSI TS 101 376-04-13
# section: 9.2.26           MES CAPABILITY INFORMATION CONFIRM
# top-level object: MES CAPABILITY INFORMATION CONFIRM message content
...
mes_capability_information_confirm_message_content = CSN1List(name='mes_capability_information_confirm_message_content', list=[
  CSN1Val(name='', val='0'),
  CSN1List(list=[
