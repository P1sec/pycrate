...
# *
# *--------------------------------------------------------
# * File Name : pycrate_gmr1_csn1/rrc_connection_release_complete_message_content.py
# * Created : 2023-10-24
# * Authors : Benoit Michau
# *--------------------------------------------------------
#*/
# specification: ETSI TS 101 376-04-13
# section: 9.2.39          RRC CONNECTION RELEASE COMPLETE
# top-level object: RRC CONNECTION RELEASE COMPLETE message content
...
rrc_connection_release_complete_message_content = CSN1List(name='rrc_connection_release_complete_message_content', list=[
  ...
  CSN1Alt(alt={
    '0': ('', []),
    '1': ('', [
    CSN1Ref(name='error_indication', obj=failure_cause_and_error_information_ie)])})])
