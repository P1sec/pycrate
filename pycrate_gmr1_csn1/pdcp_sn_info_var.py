...
# *
# *--------------------------------------------------------
# * File Name : pycrate_gmr1_csn1/pdcp_sn_info_var.py
# * Created : 2023-10-24
# * Authors : Benoit Michau
# *--------------------------------------------------------
#*/
# specification: ETSI TS 101 376-04-13
# section: 10.4.18 PDCP_SN_INFO
# top-level object: PDCP_SN_INFO VAR
...
pdcp_sn_info_var = CSN1Alt(name='pdcp_sn_info_var', alt={
  '0': ('', []),
  '1': ('', [
