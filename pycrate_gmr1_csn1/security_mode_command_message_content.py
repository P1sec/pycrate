...
# *
# *--------------------------------------------------------
# * File Name : pycrate_gmr1_csn1/security_mode_command_message_content.py
# * Created : 2023-10-24
# * Authors : Benoit Michau
# *--------------------------------------------------------
#*/
# specification: ETSI TS 101 376-04-13
# section: 9.2.45           SECURITY MODE COMMAND
# top-level object: SECURITY MODE COMMAND message content
...
from pycrate_gmr1_csn1.gsm_mes_security_capability_ie import gsm_mes_security_capability_ie
...
security_mode_command_message_content = CSN1List(name='security_mode_command_message_content', list=[
  CSN1Val(name='', val='0'),
  CSN1List(list=[
    ...
    CSN1Alt(alt={
      '0': ('', []),
      '1': ('', [
      CSN1Ref(name='gsm_mes_security_capability', obj=gsm_mes_security_capability_ie)])}),
    CSN1Bit(name='check_last_used_ciphering_algorithm')])])
