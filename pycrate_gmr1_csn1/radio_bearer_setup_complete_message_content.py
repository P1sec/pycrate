...
# *
# *--------------------------------------------------------
# * File Name : pycrate_gmr1_csn1/radio_bearer_setup_complete_message_content.py
# * Created : 2023-10-24
# * Authors : Benoit Michau
# *--------------------------------------------------------
#*/
# specification: ETSI TS 101 376-04-13
# section: 9.2.35 RADIO BEARER SETUP COMPLETE
# top-level object: RADIO BEARER SETUP COMPLETE message content
...
radio_bearer_setup_complete_message_content = CSN1List(name='radio_bearer_setup_complete_message_content', list=[
