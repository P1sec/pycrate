...
# *
# *--------------------------------------------------------
# * File Name : pycrate_gmr1_csn1/radio_bearer_setup_message_content.py
# * Created : 2023-10-24
# * Authors : Benoit Michau
# *--------------------------------------------------------
#*/
# specification: ETSI TS 101 376-04-13
# section: 9.2.34          RADIO BEARER SETUP
# top-level object: RADIO BEARER SETUP message content
...
radio_bearer_setup_message_content = CSN1List(name='radio_bearer_setup_message_content', list=[
  CSN1Val(name='', val='0'),
  CSN1List(list=[
