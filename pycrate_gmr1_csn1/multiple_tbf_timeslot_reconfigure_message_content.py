...
# *
# *--------------------------------------------------------
# * File Name : pycrate_gmr1_csn1/multiple_tbf_timeslot_reconfigure_message_content.py
# * Created : 2023-10-24
# * Authors : Benoit Michau
# *--------------------------------------------------------
#*/
# specification: ETSI TS 101 376-04-12
# section: 11.2.28 Multiple TBF Timeslot Reconfigure (Iu mode only)
...
from pycrate_gmr1_csn1.multiple_tbf_downlink_assignment_message_content import downlink_tbf_assignment_struct
