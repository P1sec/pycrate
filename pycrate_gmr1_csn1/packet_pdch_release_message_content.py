...
# *
# *--------------------------------------------------------
# * File Name : pycrate_gmr1_csn1/packet_pdch_release_message_content.py
# * Created : 2023-10-24
# * Authors : Benoit Michau
# *--------------------------------------------------------
#*/
# specification: ETSI TS 101 376-04-12
# section: 11.2.11 Packet PDCH release (Iu mode only)
...
packet_pdch_release_message_content = CSN1List(name='packet_pdch_release_message_content', list=[
  CSN1List(list=[
    CSN1Val(name='', val='1'),
    CSN1Bit(name='macslots_available', bit=8)]),
