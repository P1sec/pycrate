...
# *
# *--------------------------------------------------------
# * File Name : pycrate_gmr1_csn1/handover_complete_message_content.py
# * Created : 2023-10-24
# * Authors : Benoit Michau
# *--------------------------------------------------------
#*/
# specification: ETSI TS 101 376-04-13
# section: 9.2.14          HANDOVER COMPLETE
# top-level object: HANDOVER COMPLETE message content
...
handover_complete_message_content = CSN1List(name='handover_complete_message_content', list=[
