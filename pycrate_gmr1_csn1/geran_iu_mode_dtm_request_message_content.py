...
# *
# *--------------------------------------------------------
# * File Name : pycrate_gmr1_csn1/geran_iu_mode_dtm_request_message_content.py
# * Created : 2023-10-24
# * Authors : Benoit Michau
# *--------------------------------------------------------
#*/
# specification: ETSI TS 101 376-04-13
# section: 9.2.57          GERAN Iu mode DTM REQUEST
# top-level object: GERAN Iu mode DTM REQUEST message content
...
geran_iu_mode_dtm_request_message_content = CSN1List(name='geran_iu_mode_dtm_request_message_content', list=[
  CSN1Alt(alt={
    '0': ('', []),
    '1': ('', [
  ...
  CSN1Ref(name='iu_mode_rrc_channel_request_description', obj=iu_mode_channel_request_description_ie)])
