...
# section: 9.2.32          RADIO BEARER RELEASE COMPLETE
...
radio_bearer_release_complete_message_content = CSN1List(name='radio_bearer_release_complete_message_content', list=[
