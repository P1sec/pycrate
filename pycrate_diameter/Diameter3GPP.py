...
TGPPAVPInfos_dict = {
    ...
    3500 : ('BMSC‑Address', Address),
    3501 : ('BMSC‑Port', Unsigned32),
    3502 : ('MBMS‑Bearer‑Event', Unsigned32),
    3503 : ('MBMS‑Bearer‑Event‑Notification', Grouped),
    3504 : ('MBMS‑Bearer‑Request', Grouped),
    3505 : ('MBMS‑Bearer‑Response', Grouped),
    3506 : ('MBMS‑Bearer‑Result', Unsigned32),
    3507 : ('MBMS‑Start‑Time', Time),
    3508 : ('Radio‑Frequency', Unsigned32),
    3509 : ('TMGI‑Allocation‑Request', Grouped),
    3510 : ('TMGI‑Allocation‑Response', Grouped),
    3511 : ('TMGI‑Allocation‑Result', Unsigned32),
    3512 : ('TMGI‑Deallocation‑Request', Grouped),
    3513 : ('TMGI‑Deallocation‑Response', Grouped),
    3514 : ('TMGI‑Deallocation‑Result', Unsigned32),
    ...
    3529 : ('Userplane-Protocol‑Result', Grouped),
