...
class DIBHeader(Envelope):
    _GEN = (
        ...
        Uint32LE('Width', val=0),
        Uint32LE('Height', val=0),
        Uint16LE('Planes', val=0),
        Uint16LE('BitsPerPixel', val=0),
        Uint32LE('Comp', val=0),
        Uint32LE('ImageSize', val=0),
        Uint32LE('XPixelsPerMeter', val=0),
        Uint32LE('YPixelsPerMeter', val=0),
        Uint32LE('ColorsInColorTable'),
        Uint32LE('ImportantColorCount', val=0),
        Uint32LE('RedChannelBitmask', val=0, rep=REPR_HEX),
        Uint32LE('GreenChannelBitmask', val=0, rep=REPR_HEX),
        Uint32LE('BlueChannelBitmask', val=0, rep=REPR_HEX),
        Uint32LE('AlphaChannelBitmask', val=0, rep=REPR_HEX),
        Uint32LE('ColorSpaceType', val=0),
        Uint32LE('ColorSpaceEndpoints', val=0),
        Uint32LE('GammaRed', val=0),
        Uint32LE('GammaGreen', val=0),
        Uint32LE('GammaBlue', val=0),
        Uint32LE('Intent', val=0),
        Uint32LE('ICCProfileData', val=0),
