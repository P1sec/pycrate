...
class ERS:
    ...
    _ArchiveTimeStamp_digestAlgorithm = SEQ(name=u'digestAlgorithm', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PKIX1Explicit88', 'AlgorithmIdentifier')), opt=True)
    ...
    _ArchiveTimeStamp_timeStamp = SEQ(name=u'timeStamp', mode=MODE_TYPE, typeref=ASN1RefType(('CryptographicMessageSyntax2004', 'ContentInfo')))
    ...
    _EncryptionInfo_encryptionInfoType = OID(name=u'encryptionInfoType', mode=MODE_TYPE)
    _EncryptionInfo_encryptionInfoValue = ANY(name=u'encryptionInfoValue', mode=MODE_TYPE, defby=u'encryptionInfoType')
