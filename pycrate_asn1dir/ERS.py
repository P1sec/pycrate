...
class ERS:
    ...
    __EvidenceRecord_digestAlgorithms__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('PKIX1Explicit88', 'AlgorithmIdentifier')))
    ...
    _CryptoInfos__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('CryptographicMessageSyntax2004', 'Attribute')))
    ...
    _ArchiveTimeStamp_digestAlgorithm = SEQ(name='digestAlgorithm', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('PKIX1Explicit88', 'AlgorithmIdentifier')), opt=True)
    ...
    _ArchiveTimeStamp_timeStamp = SEQ(name='timeStamp', mode=MODE_TYPE, typeref=ASN1RefType(('CryptographicMessageSyntax2004', 'ContentInfo')))
    ...
    _Attributes__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('CryptographicMessageSyntax2004', 'Attribute')))
    ...
    _EncryptionInfo_encryptionInfoType = OID(name='encryptionInfoType', mode=MODE_TYPE)
    _EncryptionInfo_encryptionInfoValue = ANY(name='encryptionInfoValue', mode=MODE_TYPE, defby='encryptionInfoType')
...
init_modules(PKIX1Explicit88, PKIX1Implicit88, PKIXAttributeCertificate, AttributeCertificateVersion1, CryptographicMessageSyntax2004, ERS)
