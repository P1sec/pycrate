...
class ExtendedSecurityServices_2006:
    ...
    _name_  = u'ExtendedSecurityServices-2006'
    ...
    _ReceiptRequest_signedContentIdentifier = OCT_STR(name=u'signedContentIdentifier', mode=MODE_TYPE, typeref=ASN1RefType(('ExtendedSecurityServices-2006', 'ContentIdentifier')))
    _ReceiptRequest_receiptsFrom = CHOICE(name=u'receiptsFrom', mode=MODE_TYPE, typeref=ASN1RefType(('ExtendedSecurityServices-2006', 'ReceiptsFrom')))
    ...
    _ReceiptsFrom_allOrFirstTier = INT(name=u'allOrFirstTier', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('ExtendedSecurityServices-2006', 'AllOrFirstTier')))
    ...
    _Receipt_version = INT(name=u'version', mode=MODE_TYPE, typeref=ASN1RefType(('ExtendedSecurityServices-2006', 'ESSVersion')))
    _Receipt_contentType = OID(name=u'contentType', mode=MODE_TYPE, typeref=ASN1RefType(('CryptographicMessageSyntax2004', 'ContentType')))
    _Receipt_signedContentIdentifier = OCT_STR(name=u'signedContentIdentifier', mode=MODE_TYPE, typeref=ASN1RefType(('ExtendedSecurityServices-2006', 'ContentIdentifier')))
    ...
    _ContentHints_contentType = OID(name=u'contentType', mode=MODE_TYPE, typeref=ASN1RefType(('CryptographicMessageSyntax2004', 'ContentType')))
    ...
    _ContentReference_contentType = OID(name=u'contentType', mode=MODE_TYPE, typeref=ASN1RefType(('CryptographicMessageSyntax2004', 'ContentType')))
    _ContentReference_signedContentIdentifier = OCT_STR(name=u'signedContentIdentifier', mode=MODE_TYPE, typeref=ASN1RefType(('ExtendedSecurityServices-2006', 'ContentIdentifier')))
    ...
    _ESSSecurityLabel_security_policy_identifier = OID(name=u'security-policy-identifier', mode=MODE_TYPE, typeref=ASN1RefType(('ExtendedSecurityServices-2006', 'SecurityPolicyIdentifier')))
    _ESSSecurityLabel_security_classification = INT(name=u'security-classification', mode=MODE_TYPE, typeref=ASN1RefType(('ExtendedSecurityServices-2006', 'SecurityClassification')), opt=True)
    _ESSSecurityLabel_privacy_mark = CHOICE(name=u'privacy-mark', mode=MODE_TYPE, typeref=ASN1RefType(('ExtendedSecurityServices-2006', 'ESSPrivacyMark')), opt=True)
    _ESSSecurityLabel_security_categories = SET_OF(name=u'security-categories', mode=MODE_TYPE, typeref=ASN1RefType(('ExtendedSecurityServices-2006', 'SecurityCategories')), opt=True)
    ...
    _MLData_mailListIdentifier = CHOICE(name=u'mailListIdentifier', mode=MODE_TYPE, typeref=ASN1RefType(('ExtendedSecurityServices-2006', 'EntityIdentifier')))
    _MLData_expansionTime = TIME_GEN(name=u'expansionTime', mode=MODE_TYPE)
    _MLData_mlReceiptPolicy = CHOICE(name=u'mlReceiptPolicy', mode=MODE_TYPE, typeref=ASN1RefType(('ExtendedSecurityServices-2006', 'MLReceiptPolicy')), opt=True)
    ...
    _EntityIdentifier_issuerAndSerialNumber = SEQ(name=u'issuerAndSerialNumber', mode=MODE_TYPE, typeref=ASN1RefType(('CryptographicMessageSyntax2004', 'IssuerAndSerialNumber')))
    _EntityIdentifier_subjectKeyIdentifier = OCT_STR(name=u'subjectKeyIdentifier', mode=MODE_TYPE, typeref=ASN1RefType(('CryptographicMessageSyntax2004', 'SubjectKeyIdentifier')))
    ...
    _ESSCertIDv2_hashAlgorithm = SEQ(name=u'hashAlgorithm', mode=MODE_TYPE, typeref=ASN1RefType(('PKIX1Explicit88', 'AlgorithmIdentifier')), default=dict([(u'algorithm', (2, 16, 840, 1, 101, 3, 4, 2, 1))]))
    _ESSCertIDv2_certHash = OCT_STR(name=u'certHash', mode=MODE_TYPE, typeref=ASN1RefType(('ExtendedSecurityServices-2006', 'Hash')))
    _ESSCertIDv2_issuerSerial = SEQ(name=u'issuerSerial', mode=MODE_TYPE, typeref=ASN1RefType(('ExtendedSecurityServices-2006', 'IssuerSerial')), opt=True)
    ...
    _ESSCertID_certHash = OCT_STR(name=u'certHash', mode=MODE_TYPE, typeref=ASN1RefType(('ExtendedSecurityServices-2006', 'Hash')))
    _ESSCertID_issuerSerial = SEQ(name=u'issuerSerial', mode=MODE_TYPE, typeref=ASN1RefType(('ExtendedSecurityServices-2006', 'IssuerSerial')), opt=True)
    ...
    IssuerSerial = SEQ(name=u'IssuerSerial', mode=MODE_TYPE)
    _IssuerSerial_issuer = SEQ_OF(name=u'issuer', mode=MODE_TYPE, typeref=ASN1RefType(('PKIX1Implicit88', 'GeneralNames')))
    _IssuerSerial_serialNumber = INT(name=u'serialNumber', mode=MODE_TYPE, typeref=ASN1RefType(('PKIX1Explicit88', 'CertificateSerialNumber')))
    IssuerSerial._cont = ASN1Dict([
        (u'issuer', _IssuerSerial_issuer),
