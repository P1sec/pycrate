...
class CMS_AuthEnvelopedData_2007:

    _name_  = 'CMS-AuthEnvelopedData-2007'
    _oid_   = [1, 2, 840, 113549, 1, 9, 16, 0, 31]
    ...
    _AuthEnvelopedData_version = INT(name='version', mode=MODE_TYPE, typeref=ASN1RefType(('CryptographicMessageSyntax2004', 'CMSVersion')))
    _AuthEnvelopedData_originatorInfo = SEQ(name='originatorInfo', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('CryptographicMessageSyntax2004', 'OriginatorInfo')), opt=True)
    _AuthEnvelopedData_recipientInfos = SET_OF(name='recipientInfos', mode=MODE_TYPE, typeref=ASN1RefType(('CryptographicMessageSyntax2004', 'RecipientInfos')))
    _AuthEnvelopedData_authEncryptedContentInfo = SEQ(name='authEncryptedContentInfo', mode=MODE_TYPE, typeref=ASN1RefType(('CryptographicMessageSyntax2004', 'EncryptedContentInfo')))
    _AuthEnvelopedData_authAttrs = SET_OF(name='authAttrs', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('CryptographicMessageSyntax2004', 'AuthAttributes')), opt=True)
    _AuthEnvelopedData_mac = OCT_STR(name='mac', mode=MODE_TYPE, typeref=ASN1RefType(('CryptographicMessageSyntax2004', 'MessageAuthenticationCode')))
    _AuthEnvelopedData_unauthAttrs = SET_OF(name='unauthAttrs', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('CryptographicMessageSyntax2004', 'UnauthAttributes')), opt=True)
...
init_modules(PKIX1Explicit88, PKIX1Implicit88, PKIXAttributeCertificate, AttributeCertificateVersion1, CryptographicMessageSyntax2004, CMS_AuthEnvelopedData_2007)
