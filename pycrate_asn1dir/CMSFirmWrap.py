...
class CMSFirmwareWrapper:
    ...
    _FirmwarePackageIdentifier_name = CHOICE(name='name', mode=MODE_TYPE, typeref=ASN1RefType(('CMSFirmwareWrapper', 'PreferredOrLegacyPackageIdentifier')))
    _FirmwarePackageIdentifier_stale = CHOICE(name='stale', mode=MODE_TYPE, typeref=ASN1RefType(('CMSFirmwareWrapper', 'PreferredOrLegacyStalePackageIdentifier')), opt=True)
    ...
    _PreferredOrLegacyPackageIdentifier_preferred = SEQ(name='preferred', mode=MODE_TYPE, typeref=ASN1RefType(('CMSFirmwareWrapper', 'PreferredPackageIdentifier')))
    ...
    _CommunityIdentifier_hwModuleList = SEQ(name='hwModuleList', mode=MODE_TYPE, typeref=ASN1RefType(('CMSFirmwareWrapper', 'HardwareModules')))
    ...
    #-----< WrappedFirmwareKey >-----#
    WrappedFirmwareKey = SEQ(name='WrappedFirmwareKey', mode=MODE_TYPE, typeref=ASN1RefType(('CryptographicMessageSyntax2004', 'EnvelopedData')))
    ...
    _FirmwarePackageLoadReceipt_version = INT(name='version', mode=MODE_TYPE, typeref=ASN1RefType(('CMSFirmwareWrapper', 'FWReceiptVersion')), default=1)
    ...
    _FirmwarePackageLoadReceipt_fwPkgName = CHOICE(name='fwPkgName', mode=MODE_TYPE, typeref=ASN1RefType(('CMSFirmwareWrapper', 'PreferredOrLegacyPackageIdentifier')))
    ...
    _FirmwarePackageLoadError_version = INT(name='version', mode=MODE_TYPE, typeref=ASN1RefType(('CMSFirmwareWrapper', 'FWErrorVersion')), default=1)
    ...
    _FirmwarePackageLoadError_errorCode = ENUM(name='errorCode', mode=MODE_TYPE, typeref=ASN1RefType(('CMSFirmwareWrapper', 'FirmwarePackageLoadErrorCode')))
    _FirmwarePackageLoadError_vendorErrorCode = INT(name='vendorErrorCode', mode=MODE_TYPE, typeref=ASN1RefType(('CMSFirmwareWrapper', 'VendorLoadErrorCode')), opt=True)
    _FirmwarePackageLoadError_fwPkgName = CHOICE(name='fwPkgName', mode=MODE_TYPE, typeref=ASN1RefType(('CMSFirmwareWrapper', 'PreferredOrLegacyPackageIdentifier')), opt=True)
    ...
    _CurrentFWConfig_fwPkgName = CHOICE(name='fwPkgName', mode=MODE_TYPE, typeref=ASN1RefType(('CMSFirmwareWrapper', 'PreferredOrLegacyPackageIdentifier')))
