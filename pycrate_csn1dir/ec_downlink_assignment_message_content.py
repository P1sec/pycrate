...
# section: 9.1.64 EC DOWNLINK ASSIGNMENT
# top-level object: EC Downlink Assignment message content
...
ec_downlink_assignment_message_content = CSN1List(name='ec_downlink_assignment_message_content', list=[
