...
# section: 11.2.53 EC Packet Downlink Dummy Control Block
# top-level object: EC Packet Downlink Dummy Control Block message content
...
ec_packet_downlink_dummy_control_block_message_content = CSN1List(name='ec_packet_downlink_dummy_control_block_message_content', list=[
