...
# section: 12.9 Global Power Control Parameters
# top-level object: Global Power Control Parameters IE
...
global_power_control_parameters_ie = CSN1List(name='global_power_control_parameters_ie', list=[
