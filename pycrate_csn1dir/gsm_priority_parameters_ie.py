...
# section: 12.51 GSM Priority Parameters
# top-level object: GSM Priority Parameters IE
...
gsm_priority_parameters_ie = CSN1List(name='gsm_priority_parameters_ie', list=[
