...
# section: 12.60 E-UTRAN CSG Measurement Report
# top-level object: E-UTRAN CSG Measurement Report IE
...
e_utran_csg_measurement_report_ie = CSN1List(name='e_utran_csg_measurement_report_ie', list=[
